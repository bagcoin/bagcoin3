...
sgminer.exe -k x13mod -o stratum+tcp://stratum.8baochi.com:3337 -u myminer.123 -p 123456 --intensity 19 --worksize 128 --thread-concurrency 8192 --expiry 1 --scan-time 1 --queue 5 --gpu-fan 60 
