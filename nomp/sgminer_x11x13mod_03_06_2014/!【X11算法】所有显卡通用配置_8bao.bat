...
sgminer.exe -k x11mod -o stratum+tcp://bagcoin.org:5555 -u bCpH6WfGf6q6ktzE4164atRnxDWua9KLgP -p 123456 --intensity 19 --worksize 64 --thread-concurrency 8192 --expiry 1 --scan-time 1 --queue 5 --gpu-fan 60 
