...
sgminer.exe -k x11mod -o stratum+tcp://stratum.8baochi.com:3336 -u myminer.123 -p 123456 --intensity 19 --worksize 128 --thread-concurrency 8192 --expiry 1 --scan-time 1 --queue 5 --gpu-fan 60 --gpu-engine 1100 --gpu-memclock 1500
